...
#define NCI_NFCC_CONFIG_CONTROL_CMD  { 0x20, 0x02, 0x04, 0x01, 0x85, 0x01, 0x01}
#define NCI_SWITCH_RF_FIELD_CMD_1    { 0x2F, 0x0E, 0x02, 0x00, 0x80}
#define NCI_SWITCH_RF_FIELD_CMD_2    { 0x2F, 0x3F, 0x02, 0x01, 0x00}
#define NCI_SWITCH_RF_FIELD_CMD_3    { 0x2F, 0x3F, 0x01, 0x00}
#define NCI_SWITCH_RF_FIELD_CMD_4    { 0x2F, 0x3F, 0x02, 0x01, 0x01}
#define NCI_SWITCH_RF_FIELD_CMD_5    { 0x2F, 0x3F, 0x02, 0x02, 0x01}
#define NCI_SWITCH_RF_FIELD_CMD_6    { 0x2F, 0x3F, 0x02, 0x02, 0x00}
...
#define NCI_LOAD_PROTOCOL_SUB_CMD_1  { 0x2F, 0x3F, 0x02, 0x01, 0x00 }
#define NCI_LOAD_PROTOCOL_SUB_CMD_2  { 0x2F, 0x3F, 0x01, 0x00 }
#define NCI_PRBS_CMD_1               { 0x2F, 0x0E, 0x02, 0x00, 0x80 }
#define NCI_PRBS_CMD_2               { 0x2F, 0x3F, 0x02, 0x01, 0x00 }
#define NCI_PRBS_CMD_3               { 0x2F, 0x30, 0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 }
#define NCI_PRBS_CMD_4               { 0x2F, 0x3F, 0x01, 0x00 }
#define NCI_PRBS_CMD_5               { 0x2F, 0x3F, 0x02, 0x01, 0x00 }
#define NCI_PRBS_CMD_6               { 0x2F, 0x30, 0x06, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00 }
#define NCI_PRBS_CMD_7               { 0x2F, 0x3F, 0x01, 0x00 }
#define NCI_PRBS_CMD_8               { 0x2F, 0x3F, 0x02, 0x01, 0x00 }
#define NCI_PRBS_CMD_9               { 0x2F, 0x30, 0x06, 0x01, 0x00, 0x02, 0x01, 0x00, 0x00 }
#define NCI_PRBS_CMD_10              { 0x2F, 0x3F, 0x01, 0x00 }
