...
•  Contents:
   o    SmcuSwitchV1_0TargetTest.cpp      -> Source file
...
•  How to build the executable:
   ...
   o STEP3: It will build SmcuSwitchV1_0 under following folder
             out/target/product/hikey960/testcases/SmcuSwitchV1_0/arm64/

•  How to do SMCU_Switch:
   o STEP1: Push this file to system/lib64/ folder
             i.e. adb push SmcuSwitchV1_0 /system/bin/
   o STEP2: Run SmcuSwitchV1_0 from command line.
   ...
   o STEP3: It will ask for USER input. Enter valid input
              Select the option
                 ...
                 3. Exit execution       (Application will stop the execution)
...
•  Note:
   ...
   o If you want o/p to be stored in xml file, please use --gtes_output=[xml:"FILE_PATH"] flag.
        e.g.
           $SmcuSwitchV1_0 --gtes_color=yes --gtes_output=xml:"system/bin/SmcuSwitch.xml"
###################################################################################################
